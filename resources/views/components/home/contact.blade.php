...
<section id="contact" class="bg-white py-20 lg:py-[120px] overflow-hidden relative z-0 dark:bg-sky-800">
    <div class="container">
        <div class="flex flex-wrap lg:justify-between -mx-4">
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <p class="text-base text-body-color dark:text-gray-300 leading-relaxed mb-9">
                        ...
                        <div class="flex mb-8 max-w-[370px] w-full">
                            <div
                                class="
                                    ...
                                    rounded
                                ">
                                <svg width="24" height="26" viewBox="0 0 24 26" class="fill-current dark:text-gray-800">
                                    <path
                            ...
                            <div class="w-full">
                                <h4 class="font-bold text-dark dark:text-gray-300 text-xl mb-1">Phone Number</h4>
                                <p class="text-base text-body-color dark:text-gray-300">(+258)84 665 8196</p>
                            </div>
                        </div>
                        <div class="flex mb-8 max-w-[370px] w-full">
                            <div
                                class="
                                    ...
                                    rounded
                                ">
                                <svg width="28" height="19" viewBox="0 0 28 19" class="fill-current dark:text-gray-800">
                                    <path
                                        d="M25.3636 0H2.63636C1.18182 0 0 1.16785 0 2.6052V16.3948C0 17.8322 1.18182 19 2.63636 19H25.3636C26.8182 19 28 17.8322 28 16.3948V2.6052C28 1.16785 26.8182 0 25.3636 0ZM25.3636 1.5721C25.5909 1.5721 25.7727 1.61702 25.9545 1.75177L14.6364 8.53428C14.2273 8.75886 13.7727 8.75886 13.3636 8.53428L2.04545 1.75177C2.22727 1.66194 2.40909 1.5721 2.63636 1.5721H25.3636ZM25.3636 17.383H2.63636C2.09091 17.383 1.59091 16.9338 1.59091 16.3499V3.32388L12.5 9.8818C12.9545 10.1513 13.4545 10.2861 13.9545 10.2861C14.4545 10.2861 14.9545 10.1513 15.4091 9.8818L26.3182 3.32388V16.3499C26.4091 16.9338 25.9091 17.383 25.3636 17.383Z" />
                                </svg>
                            </div>
                            <div class="w-full">
                                <h4 class="font-bold text-dark text-xl mb-1 dark:text-gray-300">
                                    Email Address
                                </h4>
                                <p class="text-base text-body-color dark:text-gray-300">ruia.munguas@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white dark:bg-sky-700 relative rounded-lg p-8 sm:p-12 shadow-lg">
                    <form
                        action="/contact/submit" method="POST" x-data="
                            {
                                formData:{
                                    name:'',
                                    email:'',
                                ...
                                submitForm(event){
                                    ...
                                    .then(result=>{
                                        ...
                                        this.successMessage ='Thanks for your contact request. I will reply shortly.'
                                    })
                    ...
                    >
                        ...
                        @csrf
                        <div class="mb-6">
                            <x-forms.input type="text" placeholder="Your Name"
                            name="name"
                            x-model="formData.name"
                            ::class="errors.name ? 'border-red-500 focus:border-red-500' : '' "
                            >
                            <template x-if="errors.name">
                                <div x-text="errors.name[0]" class="text-red-900"></div>
                            </template>
                        </x-forms.input>
                        </div>
                        <div class="mb-6">
                            ...
                            <template x-if="errors.email">
                                <div x-text="errors.email[0]" class="text-red-900"></div>
                            </template>
                        </x-forms.input>
                        </div>
